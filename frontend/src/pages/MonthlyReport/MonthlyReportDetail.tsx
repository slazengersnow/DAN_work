...
const defaultDetailData: MonthlyDetailData = {
  ...
  data: [
    ...
    { id: 5, item: '重度身体障がい者・重度知的障がい者', values: Array(13).fill(0), suffix: '名', isDisability: true },
    { id: 6, item: 'その他障がい者', values: Array(13).fill(0), suffix: '名', isDisability: true },
    { id: 7, item: '重度身体障がい者・重度知的障がい者(パートタイム)', values: Array(13).fill(0), suffix: '名', isDisability: true },
